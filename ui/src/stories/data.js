...
export const supportingClaim = {id: 3, body: "It exists in ohhey", slug: "it-exists-in-ohhey", score: 0, creator: {username: "travis"}}
export const supportingEvidence = {id: 100, claim: supportingClaim, supports: true}

export const opposingClaim = {id: 4, body: "'This is a claim' is a tautology", slug: "this-is-a-claim-is-a-tautology", score: 100, creator: {username: "james"}}
